...
public class WrappedFabricBlockLootTableProvider
  ...
  public void generate() {
    blockLootTableProviderWrapper.generateBlockLootTables(
      this,
      new BlockLootTableProviderAccessImpl()
    );
  }

  private class BlockLootTableProviderAccessImpl
    implements BlockLootTableProviderWrapper.BlockLootTableProviderAccess {

    @Override
    public void excludeFromStrictValidation(Block block) {
      WrappedFabricBlockLootTableProvider.this.excludeFromStrictValidation(
        block
      );
    }
