...
public class CrossDataGeneratorAccessImpl implements CrossDataGeneratorAccess {
  ...
  protected CrossDataGeneratorAccessImpl(
  ...
  @Override
  public <T extends DataProvider> T addProvider(
    DataProvider.@NotNull Factory<T> factory
  ) {
  ...
  public RecipeProvider createRecipeProvider(
    ...
    // Handle null lookup for backward compatibility
    if (lookup == null) {
      lookup = CompletableFuture.completedFuture(
        RegistryAccess.fromRegistryOfRegistries(BuiltInRegistries.REGISTRY)
      );
    }
    return new WrappedFabricRecipeProvider(
  ...
  @Override
  public TagsProvider<Item> createItemTagProvider(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    ...
    if (
      !(blockTagsProvider instanceof
          FabricTagProvider.BlockTagProvider blockTagProvider)
    ) throw new IllegalArgumentException(
      "Not FabricTagProvider.BlockTagProvider"
    );
    return new WrappedFabricItemTagProvider(
      (FabricDataOutput) packOutput,
      lookup,
      blockTagProvider,
      itemTagProviderWrapper
    );
  }

  @Override
  public TagsProvider<Fluid> createFluidTagProvider(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    FluidTagProviderWrapper fluidTagProviderWrapper
  ) {
    return new WrappedFabricFluidTagProvider(
      (FabricDataOutput) packOutput,
      lookup,
      fluidTagProviderWrapper
    );
  }

  @Override
  public TagsProvider<Block> createBlockTagProvider(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    BlockTagProviderWrapper blockTagProviderWrapper
  ) {
    return new WrappedFabricBlockTagProvider(
      (FabricDataOutput) packOutput,
      lookup,
  ...
  @Override
  public TagsProvider<PoiType> createPoiTypeTagProvider(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    PoiTypeTagProviderWrapper poiTypeTagProviderWrapper
  ) {
    return new WrappedFabricPoiTypeTagProvider(
      (FabricDataOutput) packOutput,
      lookup,
      poiTypeTagProviderWrapper
    );
  }

  @Override
  public TagsProvider<DamageType> createDamageTypeTagProvider(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    DamageTypeTagsProviderWrapper damageTypeTagsProviderWrapper
  ) {
    return new WrappedFabricDamageTypeTagProvider(
      (FabricDataOutput) packOutput,
      lookup,
      damageTypeTagsProviderWrapper
    );
  }

  @Override
  public TagsProvider<Biome> createBiomeTagProvider(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    BiomeTagsProviderWrapper biomeTagsProviderWrapper
  ) {
    return new WrappedFabricBiomeTagProvider(
      (FabricDataOutput) packOutput,
      lookup,
      biomeTagsProviderWrapper
    );
  }

  @Override
  public DataProvider createBasicProvider(
    BasicProviderWrapper basicProviderWrapper
  ) {
    return new WrappedFabricBasicProvider(basicProviderWrapper);
  }

  @Override
  public DataProvider createBlockLootTableProvider(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    ...
    return new WrappedFabricBlockLootTableProvider(
      (FabricDataOutput) packOutput,
      lookup,
  ...
  @Override
  public DataProvider createAdvancementProvider(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    ...
    return new WrappedFabricAdvancementProvider(
      (FabricDataOutput) packOutput,
      lookup,
  ...
  @Override
  public DataProvider createItemModelProvider(
    PackOutput packOutput,
    ItemModelProviderWrapper itemModelProviderWrapper
  ) {
    return new WrappedFabricItemModelProvider(
      (FabricDataOutput) packOutput,
      itemModelProviderWrapper
    );
  }

  @Override
  public DataProvider createBlockStateAndModelProvider(
    PackOutput packOutput,
    BlockStateAndModelProviderWrapper blockStateAndModelProviderWrapper
  ) {
    return new WrappedFabricBlockModelProvider(
      (FabricDataOutput) packOutput,
      this,
      blockStateAndModelProviderWrapper
    );
  }

  @Override
  public RegistriesDatapackGenerator createRegistriesDatapackGenerator(
    PackOutput packOutput,
    CompletableFuture<HolderLookup.Provider> lookup,
    RegistrySetBuilder registrySetBuilder
  ) {
    return new WrappedRegistriesDatapackGenerator(
      packOutput,
      lookup,
      registrySetBuilder
    );
